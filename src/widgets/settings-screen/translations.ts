...
export const settingsScreenTranslations = {
	ru: {
		...
		clearIndexedDbDetail: "Все подходы и дневная цель в локальной базе (IndexedDB). Настройки интерфейса не удаляются.",
		clearIndexedDbConfirm: "Удалить все записи?",
		clearLocalStorage: "Сбросить настройки интерфейса",
		clearLocalStorageDetail:
			"Тема, часовой пояс и пользовательские быстрые кнопки (localStorage). Данные тренировок не затрагиваются.",
